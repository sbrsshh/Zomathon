...
jwt = JWTManager()
migrate = Migrate()
# Important: socketio initialized with eventlet and cors_allowed_origins
...
def create_app():
    ...
    # ✅ Import models BEFORE creating tables (Using plural 'interactions')
    from server.app.models import user, restaurant, interactions, order
